...
export function CakeIcon(props: SVGAttributes<SVGElement>) {
  return (
    <svg
      fill="currentColor"
      version="1.1"
      id="Capa_1"
      viewBox="0 0 526.199 526.199"
      {...props}
    >
      <g>
        <path
          d="M220.6,133.4c0-12.1,9.9-22,22-22s22,9.8,22,22c0,12.1-9.899,21.9-22,21.9S220.6,145.5,220.6,133.4z M285.301,162.6
